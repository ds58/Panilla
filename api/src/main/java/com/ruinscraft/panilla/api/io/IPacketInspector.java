...
public interface IPacketInspector {
	...
	default void checkPlayIn(Object _player, Object _packet) throws OversizedPacketException, NbtNotPermittedException, SignLineLengthTooLongException {
		checkSize(_packet);
		checkPacketPlayInSetCreativeSlot(_packet);
		checkPacketPlayInUpdateSign(_packet);
	}
	
	default void checkPlayOut(Object _packet) throws OversizedPacketException, NbtNotPermittedException, SignLineLengthTooLongException {
		checkSize(_packet);
